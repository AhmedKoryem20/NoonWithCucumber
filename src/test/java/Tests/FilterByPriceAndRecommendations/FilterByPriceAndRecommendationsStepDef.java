...
public class FilterByPriceAndRecommendationsStepDef extends BaseTest {
    private static final Logger log = LogManager.getLogger(FilterByPriceAndRecommendationsStepDef.class);
